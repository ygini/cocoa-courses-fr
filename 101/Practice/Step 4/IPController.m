...
-(IBAction)open:(id)sender {
	...
	if ([openPanel runModal] == NSFileHandlingPanelOKButton) 
		for (NSString *path in [openPanel filenames]) [playList addObject:[MusicModel musicWithPath:path]];
}
...
- (void) awakeFromNib {
	...
	[playList addObject:[MusicModel musicWithPath:[[NSBundle mainBundle] pathForResource:@"ModelViewController" ofType:@"mp3"]]];
